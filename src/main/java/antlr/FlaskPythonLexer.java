...
public class FlaskPythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FROM", "IMPORT", "DEF", "CLASS", "RETURN", "IF", "ELIF", "ELSE", "FOR", 
			"IN", "GLOBAL", "ASSIGN", "COMMA", "COLON", "DOT", "AT", "LPAREN", "RPAREN", 
			"LBRACK", "RBRACK", "LBRACE", "RBRACE", "PLUS", "MINUS", "STAR", "DIV", 
			"EQ", "NEQ", "GT", "LT", "STRING", "FSTRING", "NUMBER", "ID", "NEWLINE", 
			"WS", "COMMENT"
		};
	}
